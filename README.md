...
The sentry extension can be found [here](asgi_correlation_id_sentry/README.md)
and the celery extension can be found [here](asgi_correlation_id_sentry/README.md).

To install the extension install the package with `pip install asgi-correlation-id[celery]`, `[sentry]`, or `[celery,sentry]`.
